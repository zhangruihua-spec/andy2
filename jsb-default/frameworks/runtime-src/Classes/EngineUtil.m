...
{
//    NSString *deviceInfo = user_defaults_get_string(@"_global_idfv_device_info");
//
//    deviceInfo = [deviceInfo stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
//    return deviceInfo;
...
//在Info.plist中添加UIFileSharingEnabled为YES，可以用PP助手等工具查看Document内容
