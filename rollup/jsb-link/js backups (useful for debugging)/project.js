...
i[n][0].call(h.exports, function(e) {
return c(i[n][1][e] || e);
}, h, h.exports, e, i, t, s);
}
return t[n].exports;
...
var r = cc.repeatForever(cc.sequence(cc.fadeIn(1), cc.fadeOut(1), cc.rotateBy(2, 360))), d = cc.repeatForever(cc.sequence(cc.rotateBy(2, 360), cc.fadeIn(1), cc.fadeOut(1)));
this.light.runAction(r);
this.light0.runAction(d);
},
game_again: function() {
cc.director.loadScene("rolling");
},
...
var t = cc.tintTo(2, 255, 254, 203), s = cc.tintTo(2, 204, 204, 204), c = cc.tintTo(2, 204, 255, 154), o = cc.tintTo(2, 254, 204, 203), n = cc.tintTo(2, 204, 255, 255), a = cc.tintTo(2, 204, 204, 254), r = cc.fadeIn(1), d = cc.fadeIn(1), h = cc.fadeOut(1), l = cc.fadeOut(1);
...
4 == e.node.order && this.startbridge.runAction(h);
...
var m = this.score;
setTimeout(function() {
this.allbridge && this.allbridge[m].runAction(h);
}.bind(this), 5e3);
setTimeout(function() {
...
jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "showAlertDialog", "(Ljava/lang/String;Ljava/lang/String;)V", "title", e);
bugly += "消息出错会在bugly报错 ";
},
