        ...
        window.plugin = new window.Vue({
            ...
            methods: {
                ...
                onUploadBuglySymbol() {
                    ...
                    let soPath1 = PATH.join(androidProjectRoot, "app/build/intermediates/ndkBuild/debug/obj/local/armeabi-v7a/libcocos2djs.so");//手机上这种多,也是cocos默认的
                    let soPath2 = PATH.join(androidProjectRoot, "app/build/intermediates/ndkBuild/debugdebugdebug/obj/local/armeabi/libcocos2djs.so");
                    let soPath3 = PATH.join(androidProjectRoot, "app/build/intermediates/ndkBuild/debugdebug/obj/local/x86/libcocos2djs.so");// 模拟器上这种
                    let soPath4 = PATH.join(androidProjectRoot, "app/build/intermediates/ndkBuild/debug/obj/local/arm64-v8a/libcocos2djs.so");
